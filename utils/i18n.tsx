...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ...
  arabic: {
    ...
    't10.def': 'دفاع',
    'sts.title': 'Siege to Seize',
    'sts.power_boost': 'ترقية الطاقة',
    'sts.final_stand': 'المعركة الحاسمة',
    'sts.fierce_assault': 'الغارة السريعة',
    'sts.vigilant': 'تشكيلة التحذير',
    'sts.extra_drill': 'المعسكر الإضافي',
    'sts.barrack': 'توسيع الثكنات',
    'sts.focused': 'التدريب الممركز',
    'sts.drill_exp': 'توسيع المعسكر',
    'sts.rapid': 'المسيرة السريعة I',
    'sts.fatal': 'الضربة القاتلة I',
